...
$id=$_GET['ankitEditeid'];
if(isset($_REQUEST['ankitEdite']))
{   
    ...
    $sql = "update individuale_registration set id='$id' ,Login_ID='$Login_ID' ,Passwored='$Passwored' ,C_Passwored='$C_Passwored' ,Salutation='$Salutation' ,Middile_Mane='$Middile_Mane' ,Resient_Status='$Resient_Status' ,Email='$Email' ,First_Name='$First_Name' ,Last_Name='$Last_Name' ,Country='$Country' ,Mobile_No='$Mobile_No' ,Account_No='$Account_No' ,Nick_Name='$Nick_Name') where id=$id";          

    $insrt = $con->query($sql);     

    if($insrt)
    {
    echo  '<script> alert("Data Editwd Successfyll....")</script>';
    }
}
